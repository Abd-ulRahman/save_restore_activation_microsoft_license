...
net stop clipsvc
net stop sppsvc
XCOPY C:\Windows\System32\spp\store "%ScriptPath%license" /O /X /E /H /K /Y
XCOPY C:\ProgramData\Microsoft\Windows\ClipSVC\tokens.dat "%ScriptPath%GenuineTicket" /O /X /H /K /Y
...
copy C:\Windows\System32\winactivationkey.reg %ScriptPath%
